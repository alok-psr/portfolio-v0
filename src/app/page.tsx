    ...
    <div className="flex flex-col items-center min-h-screen">
      ...
      <section className="flex flex-col items-center justify-center min-h-[90vh] p-8 text-center space-y-8 max-w-4xl">
        ...
        >
          <div className="w-32 h-32 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-muted mx-auto relative z-10 bg-muted flex items-center justify-center">
             ...
             {/* <Image src="/path/to/photo.jpg" alt="Me" fill className="object-cover" /> */}
          </div>
        ...
        >
            ...
            <Link href="https://linkedin.com" target="_blank" className="text-muted-foreground hover:text-accent transition-colors">
                <Linkedin className="w-6 h-6" />
            </Link>
            <Link href="https://twitter.com" target="_blank" className="text-muted-foreground hover:text-accent transition-colors">
      ...
      <section className="w-full max-w-3xl px-4 py-20 border-t border-border/50">
        <div className="flex items-center justify-between mb-12">
            ...
            <Link href="/experience" className="text-accent hover:underline flex items-center gap-1">
